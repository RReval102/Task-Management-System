...
- вынести тесты по пакетам `smoke/regression`,
- добавить `docker-compose` для реальной БД,
- добавить pre-commit/checkstyle/spotbugs,
- оформить красивую GitHub Pages “landing” для отчёта.
